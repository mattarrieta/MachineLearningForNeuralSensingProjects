...
for index = 1:758
    tempVoltage = 0;
    for k = 1:531
        tempVoltage = tempVoltage + (currents_big.currents(k,index))/(4*pi*0.3333*10^-6* positions50(k));
    end
...
for index = 1:758
    tempVoltage = 0;
    for k = 1:531
        tempVoltage = tempVoltage + (currents_big.currents(k,index))/(4*pi*0.3333*10^-6* positions100(k));
    end
...
for index = 1:758
    tempVoltage = 0;
    for k = 1:531
        tempVoltage = tempVoltage + (currents_big.currents(k,index))/(4*pi*0.3333*10^-6* positions200(k));
    end
...
for index = 1:758
    tempVoltage = 0;
    for k = 1:531
        tempVoltage = tempVoltage + (currents_big.currents(k,index))/(4*pi*0.3333*10^-6* positions300(k));
    end
